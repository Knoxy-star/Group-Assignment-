package zw.ac.uz.dpdms.zoonotic.controller;
...
import zw.ac.uz.dpdms.zoonotic.service.ZoonoticDiseaseService;
...
/**
 * Reached through the gateway as /zoonotic-disease-service/api/incidents/**
...
public class ZoonoticDiseaseController {
    ...
    public ZoonoticDiseaseController(ZoonoticDiseaseService service, RequestContextResolver contextResolver) {
