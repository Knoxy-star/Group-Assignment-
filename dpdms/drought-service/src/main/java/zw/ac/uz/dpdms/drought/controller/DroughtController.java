package zw.ac.uz.dpdms.drought.controller;
...
import zw.ac.uz.dpdms.drought.service.DroughtService;
...
/**
 * Reached through the gateway as /drought-service/api/incidents/**
...
public class DroughtController {
    ...
    private final DroughtService service;
    private final RequestContextResolver contextResolver;

    public DroughtController(DroughtService service, RequestContextResolver contextResolver) {
