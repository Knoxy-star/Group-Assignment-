package zw.ac.uz.dpdms.mining.controller;
...
import zw.ac.uz.dpdms.mining.service.MiningAccidentService;
...
/**
 * Reached through the gateway as /mining-accident-service/api/incidents/**
...
public class MiningAccidentController {
    ...
    public MiningAccidentController(MiningAccidentService service, RequestContextResolver contextResolver) {
